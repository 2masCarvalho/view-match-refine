      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
          ...
          <div>
            ...
            {errors.morada && (
              <p className="text-sm text-destructive">{errors.morada.message}</p>
            )}
          </div>
          ...
          <div>
            <Label htmlFor="contacto_administrador">Contacto Administrador (opcional)</Label>
            <Input id="contacto_administrador" {...register('contacto_administrador')} />
          </div>
