...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.enterprise.desc": "For large management portfolios",
    "pricing.mostPopular": "Most Popular",
    "pricing.month": "/month",
    "pricing.custom": "Custom",
    "pricing.getStarted": "Get Started",
    "pricing.contactSales": "Contact Sales",
    "pricing.units50": "Up to 50 units",
    "pricing.units200": "Up to 200 units",
    "pricing.unitsUnlimited": "Unlimited units",
    ...
    "pricing.onPremise": "On-premise deployment option",
  ...
  pt: {
    ...
    "pricing.enterprise": "Enterprise",
    "pricing.enterprise.desc": "Para grandes portfólios de gestão",
    ...
    "pricing.units50": "Até 50 frações",
    "pricing.units200": "Até 200 frações",
    "pricing.unitsUnlimited": "Frações ilimitadas",
